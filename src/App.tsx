    ...
    <>
      <div className="bg-[#333]">
        <div className="banner w-full  flex bg-[url('/space.jpg')] bg-no-repeat bg-cover justify-center">
          <div className="banner__wrapper flex items-center justify-between px-10 min-h-[600px] w-full max-w-[1366px] ">
            <div className="banner__text flex flex-col gap-2 justify-center w-1/2 h-full">
            ...
            <div className="banner__image flex items-center justify-center w-1/2">
              <img
                width={400}
